...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(CleanArchitectureAnalyzerCodeFixProvider)), Shared]
    public class CleanArchitectureAnalyzerCodeFixProvider : CodeFixProvider
    {
        private static string CodeFixTitle = "Convert to upper";

        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get { /*return ImmutableArray.Create(CleanArchitectureAnalyzerAnalyzer.DiagnosticId);*/ return ImmutableArray<string>.Empty; }
        }
